...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
 Help developer to quickly intergrate picture picker from photo library PicturePicker
 DESC

  s.homepage     = "https://github.com/helinyu/PicturePicker.git"
  ...
  s.source       = { :git => "https://github.com/helinyu/PicturePicker.git", :tag => "#{s.version}" }
  ...
  # s.exclude_files = "PicturePicker/framework/*.h"
